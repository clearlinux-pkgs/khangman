...
Source0  : https://download.kde.org/stable/release-service/21.08.3/src/khangman-21.08.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/21.08.3/src/khangman-21.08.3.tar.xz.sig
...
%prep
%setup -q -n khangman-21.08.3
cd %{_builddir}/khangman-21.08.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1636073054
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/khangman-21.08.3/COPYING %{buildroot}/usr/share/package-licenses/khangman/d357e60aa8efd63b4475c3363700ba54f9a71343
cp %{_builddir}/khangman-21.08.3/COPYING.DOC %{buildroot}/usr/share/package-licenses/khangman/1bd373e4851a93027ba70064bd7dbdc6827147e1
cp %{_builddir}/khangman-21.08.3/fonts/licenseDomesticManners.txt %{buildroot}/usr/share/package-licenses/khangman/9abc28821c27419eb6f38e5c71dbc9e5eb74eb9d
cp %{_builddir}/khangman-21.08.3/fonts/licenseDustimo.txt %{buildroot}/usr/share/package-licenses/khangman/0922929cf70a15070b397fe63105c924a05cbad9
pushd clr-build
%make_install
popd
%find_lang khangman
